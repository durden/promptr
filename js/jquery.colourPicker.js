...
@requires:
jquery, colour_picker.css, jquery.colourPicker.gif
***/
...
jQuery.fn.colourPicker = function (conf) {
	...
	var config = jQuery.extend({
		...
		inputBG:	true,					// Whether to change input's bkg
	...
	if (!colourPicker.length) {
		colourPicker = jQuery('<div id="' + config.id +
	...
	return this.each(function () {
		...
		var icon	= jQuery('<a href="#"><img src="' + config.ico + 
                        '" alt="' + config.openTxt +
